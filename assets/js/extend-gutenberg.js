...
},{}],"extend-gutenberg/space-columns.js":[function(require,module,exports) {
"use strict";
...
var __ = wp.i18n.__; // Enable class control on the following blocks

var enableClassControlColumnsOnBlocks = ['core/columns'];
/**
* Add class attribute to columns block
*/

var addClassSpacingColumnsAttribute = function addClassSpacingColumnsAttribute(settings, name) {
...
var addClassSpacingColumnsInspectorControl = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
    var _props$attributes = props.attributes,
        classSpaceTop = _props$attributes.classSpaceTop,
        classSpaceBottom = _props$attributes.classSpaceBottom,
        setAttributes = props.setAttributes,
        name = props.name; // Do nothing if it's another block than our defines ones.
...
var addClassSpacingColumnsEditorInspectorControl = createHigherOrderComponent(function (BlockListBlock) {
  return function (props) {
    var _props$attributes2 = props.attributes,
        classSpaceTop = _props$attributes2.classSpaceTop,
        classSpaceBottom = _props$attributes2.classSpaceBottom,
        className = props.className,
        name = props.name; // Do nothing if it's another block than our defined ones.
    ...
    return React.createElement(BlockListBlock, _extends({}, props, {
      className: (0, _classnames.default)(className, classSpaceTop ? "has-space-top-".concat(classSpaceTop) : '', classSpaceBottom ? "has-space-bottom-".concat(classSpaceBottom) : '')
    }));
  };
...
function addClassSpacingColumnsFrontend(props, blockType, attributes) {
  ...
  var classSpaceTop = attributes.classSpaceTop,
      classSpaceBottom = attributes.classSpaceBottom;
...
require("./extend-gutenberg/space-columns");
},{"./extend-gutenberg/space-columns":"extend-gutenberg/space-columns.js"}]},{},["extend-gutenberg.js"], null)
//# sourceMappingURL=/extend-gutenberg.js.map